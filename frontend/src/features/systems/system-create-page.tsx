...
import { useCreateSystem } from "@/api/systems";
...
export default function SystemCreatePage() {
  ...
  const onSubmit = (data: Form) => {
    create.mutate(data, {
      onSuccess: (res) => navigate(`/systems/${res.data.id}`),
    });
  };

  return (
    <>
      <PageHeader title="Create System" actions={

...
import { useLocation, useUpdateLocation, useLocations } from "@/api/locations";
...
export default function LocationEditPage() {
  ...
  if (isError || !location) return <ErrorState message={error?.message} />;
  ...
  return (
    <>
      <PageHeader title="Edit Location" actions={

...
async def graph_schema() -> str:
    ...
    return (
        ...
        "— Fault has occurred/triggered a down event\n"
        ...
        "created_at, updated_at\n"
        "- DownEvent: pg_id, asset_id, fault_id, started_at, ended_at, "
        ...
        "— Maintenance schedule requires a competence\n"
